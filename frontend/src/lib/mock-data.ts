...
function generateDays(): HealthDay[] {
  ...
  for (let i = 29; i >= 0; i--) {
    ...
    days.push({
      ...
      steps: Math.round(baseSteps + (Math.random() - 0.3) * 4000 + fatigueFactor * 1000),
...
export const mockDays: HealthDay[] = generateDays();

export const mockWorkouts: Workout[] = [
  {
    id: 'w1',
    date: mockDays[29].date,
    type: 'strength',
...
export const mockChatHistory: ChatMessage[] = [
  {
    id: 'c1',
    role: 'assistant',
    content: 'Good morning! 👋 I\'ve analyzed your overnight data. Your recovery score is **72** — moderate. Your HRV dipped slightly, but sleep quality was solid at 81%. I\'d suggest a moderate-intensity workout today. Want me to generate a plan?',
    timestamp: new Date(Date.now() - 3600000).toISOString(),
  },
  {
    id: 'c2',
    role: 'user',
    content: 'Yeah, generate a workout for today. Upper body focused.',
    timestamp: new Date(Date.now() - 3500000).toISOString(),
  },
  {
    id: 'c3',
    role: 'assistant',
    content: '💪 Here\'s your **Upper Body Push** workout optimized for your current recovery:\n\n**Warm-up** (5 min)\n- Arm circles, band pull-aparts\n\n**Main Block** (40 min)\n1. Bench Press — 4×8 @ RPE 7\n2. OHP — 3×10 @ RPE 7\n3. Incline DB Press — 3×12\n4. Cable Flyes — 3×15\n5. Lateral Raises — 4×12\n6. Tricep Pushdowns — 3×15\n\n**Cooldown** (5 min)\n- Chest & shoulder stretches\n\n*Intensity kept at moderate given your HRV. Not medical advice.*',
    timestamp: new Date(Date.now() - 3400000).toISOString(),
  },
  {
    id: 'c4',
    role: 'user',
    content: 'What about my diet? Am I eating enough protein?',
    timestamp: new Date(Date.now() - 3000000).toISOString(),
  },
  {
    id: 'c5',
    role: 'assistant',
    content: '📊 Looking at your 7-day nutrition data:\n\n- **Avg protein**: 108g/day\n- **Target for your weight & activity**: 140g/day\n- **Gap**: ~32g/day\n\nYou\'re consistently under your protein target, especially on training days. This may slow recovery and muscle adaptation.\n\n**Quick fixes:**\n- Add a protein shake post-workout (+25g)\n- Greek yogurt snack before bed (+15g)\n- Extra chicken breast at lunch (+30g)\n\nWant me to generate a full meal plan for this week?\n\n*Not medical advice. Consult a healthcare professional.*',
